...
import io.ayounsi.springbootangular.domain.commons.model.CrudRepository;
...
@NoRepositoryBean
public abstract class AbstractCrudRepository<T, ID, R extends JpaRepository<T, ID>> implements CrudRepository<T, ID> {
